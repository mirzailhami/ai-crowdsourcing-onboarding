...
export const step1Schema = z.object({
  ...
  challenge_type: z
    .string()
    .min(1, { message: "Please select a challenge type" }),
});

export const step2Schema = z.object({
  participant_type: z
    .string()
    .min(1, { message: "Please select a participant type" }),
  geographic_filter: z
    .string()
    .min(1, { message: "Please select a geographic filter" }),
...
export const step3Schema = z.object({
  submission_formats: z
    .array(z.string())
    .min(1, { message: "At least one submission format is required" }),
...
export const step4Schema = z.object({
  ...
  first_prize: z
    .number()
    .min(0, { message: "First prize must be a positive number" })
    .optional(),
  second_prize: z
    .number()
    .min(0, { message: "Second prize must be a positive number" })
    .optional(),
  third_prize: z
    .number()
    .min(0, { message: "Third prize must be a positive number" })
    .optional(),
  honorable_mentions: z
    .number()
    .min(0, { message: "Honorable mentions must be a positive number" })
    .optional(),
  budget: z
    .number()
    .min(0, { message: "Total budget must be a positive number" }),
...
export const step6Schema = z.object({
  evaluation_model: z
    .string()
    .min(1, { message: "Please select an evaluation model" }),
  reviewers: z
    .array(z.string())
...
export const step7Schema = z.object({
  notification_preferences: z
    .array(z.string())
    .min(1, { message: "At least one notification preference is required" }),
  notification_methods: z
    .array(z.string())
    .min(1, { message: "At least one notification method is required" }),
  ...
  access_level: z
    .array(z.string())
    .min(1, { message: "At least one access role is required" }),
  success_metrics: z
    .string()
    .min(10, { message: "Success metrics must be at least 10 characters" })
    .optional(),
});
